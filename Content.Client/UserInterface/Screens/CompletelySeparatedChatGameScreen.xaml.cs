...
public sealed partial class CompletelySeparatedChatGameScreen : InGameScreen
{
    public CompletelySeparatedChatGameScreen()
    {
        ...
        ScreenContainer.OnResized += () =>
            OnChatResized?.Invoke(new Vector2(ScreenContainer.SizeFlagsStretchRatio, 0));
